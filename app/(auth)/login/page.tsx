      ...
      <div className="w-full max-w-md bg-[#0A0A0A]/40 backdrop-blur-md border border-white/10 rounded-2xl p-8">
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-[#0A0A0A]/40 text-[#A1A1A1]">
              Or Login with
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <button
            ...
            className="flex items-center justify-center px-4 py-3 border border-white/20 rounded-xl hover:bg-white/5 transition-colors hover:cursor-pointer disabled:opacity-50 disabled:cursor-wait"
